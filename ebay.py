# this program is designed for users to search ebay.com from the run box. it will allow the user
...
website = "https://www.ebay.com/sch/i.html?_nkw="#<search> goes here
